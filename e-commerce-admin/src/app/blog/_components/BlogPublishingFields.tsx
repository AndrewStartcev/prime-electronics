    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          />
          <p className="text-xs text-text-secondary-black mt-1">
            Будущая дата автоматически делает активную статью запланированной.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-text-secondary-black mt-1">
              Товары берутся из каталога в момент показа: цена и наличие не копируются в статью.
            </p>
          </div>
          <Button
            type="button"
            ...
            onClick={() =>
              onProductBlocksChange([
                ...productBlocks,
                {
                  ...
                  sortOrder: productBlocks.length,
                  items: [],
                },
              ])
            }
        ...
        {productBlocks.map((block, blockIndex) => (
          <div key={block.id || blockIndex} className="border border-border-gray rounded-lg p-4 space-y-3">
