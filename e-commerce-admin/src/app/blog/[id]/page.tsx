...
import { useBlog, useUpdateBlog } from "@/shared/hooks";
...
export default function EditBlogPage() {
  ...
  useEffect(() => {
    if (blog) {
      const meta =
        blog.meta && typeof blog.meta === "object" && !Array.isArray(blog.meta)
      ...
      setFormData({
        ...
        author: blog.author || "Редакция Prime",
    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 lg:space-y-6">
        ...
        <div className="flex gap-3 justify-end">
          ...
          >
            {updateBlog.isPending ? "Сохранение..." : "Сохранить изменения"}
          </Button>
        </div>
      </form>
    </div>
