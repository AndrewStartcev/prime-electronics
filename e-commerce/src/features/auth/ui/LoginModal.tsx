            ...
            {step === "phone" ? (
              ...
              >
                ...
                <p className="font-normal text-[14px] md:text-[16px] leading-[1.3] text-[rgba(19,19,20,0.4)] text-center">
                  ...
                  <a href="/privacy" target="_blank" className="underline hover:text-[#131314]">обработку персональных данных</a>{" "}
                  и <a href="/privacy" target="_blank" className="underline hover:text-[#131314]">с публичной офертой</a>
                </p>
